...
class AgentRNN(nn.Module):
    ...
    def forward(self, node_features, hidden_state=None):
        """
        Process one round.
        
        Args:
            node_features: Tensor of shape [num_agents, input_dim]
        ...
        if node_features.dim() != 2 or node_features.size(1) != self.input_dim:
        ...
        scores = self.score_head(hidden_state).squeeze(-1)
